...
function getRating(watchList){
  ...
  //filtering the movies with Director Christopher Nolan
  .filter(movie => movie.Director === "Christopher Nolan")

  //mapping over the filtered array and converting imdbRatings from string to floating point numbers
  .map(movie => parseFloat(movie.imdbRating))

  //reducing the array into the sum of all the ratings
  .reduce((sum, rating) => sum + rating)
  //dividing the sum of the ratings with the number of movies with Christopher Nolan as Director
  /
